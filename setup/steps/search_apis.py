...
class SearchAPIsStep(BaseStep):
    ...
    def run(self) -> StepResult:
        ...
        if has_existing:
            ...
            self.info(
                "Search APIs are OPTIONAL tools that enhance bapX bapX's capabilities."
            )
            self.info(
                "Without these, bapX bapX will work but won't have web search or scraping functionality."
            )
    ...
    def _show_summary(self) -> None:
        ...
        if configured:
            ...
            self.info(
                "No search tools configured - bapX bapX will work without web search capabilities."
            )
