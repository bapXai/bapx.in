...
class StartupStep(BaseStep):
    """Start bapX bapX services."""

    name = "startup"
    display_name = "Starting bapX bapX"
    order = 16
    required = True
    ...
    def run(self) -> StepResult:
        ...
        self.info("\nHow would you like to start bapX bapX?")
    ...
    def _start_docker(self, choice: str, compose_cmd_str: str) -> StepResult:
        ...
        if choice == "1":
            ...
            self.info("Starting bapX bapX with Docker Compose...")
            ...
            try:
                ...
                if "backend" in result.stdout and "frontend" in result.stdout:
                    self.success("bapX bapX services are starting up!")
                else:
                    self.warning(
    ...
    def _start_manual(self, choice: str, compose_cmd_str: str) -> StepResult:
        ...
        if choice == "1":
            ...
            self.info("Starting bapX bapX automatically (manual mode)...")
            ...
            try:
                ...
                self.success("bapX bapX services started!")
                self.info("Access bapX at: http://localhost:3000")
                self.info("\nTo view logs:")
