...
from setup.steps.kortix import bapXStep
...
class SetupWizard:
    ...
    def run(self) -> int:
        ...
        self.console.print(
            "This wizard will guide you through setting up bapX bapX, "
    ...
    def _show_final_instructions(self) -> None:
        ...
        self.console.print("\n✨ bapX bapX Setup Complete! ✨\n")

        self.console.info("bapX bapX is configured with your API keys and ready to use.")
        ...
        if self.config.setup_method == SetupMethod.DOCKER:
            self.console.info("Your bapX bapX instance is ready to use!")
            ...
            self.console.info("To start bapX bapX, run these commands in separate terminals:")
        ...
        self.console.print("\nOnce all services are running, access bapX bapX at: http://localhost:3000")
