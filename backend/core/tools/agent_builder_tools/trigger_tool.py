        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "include_kortix": {
                        "type": "boolean",
                        "description": "Whether to include the built-in bapX worker in results. Defaults to false."
                    }
                },
                "required": []
            }
...
# Event trigger methods - available in all environments
    ...
    async def create_event_trigger(
        ...
        try:
            ...
            # Build bapX trigger config (same as API)
            ...
            try:
                ...
                logger.error(f"Failed to create bapX trigger: {e}")
                return self.fail_response(f"Failed to create bapX trigger: {str(e)}")
