...
def build_analysis_prompt(existing_categories: List[str]) -> str:
    ...
    return f"""You are analyzing conversations from bapX, an open-source AI agent platform.

## ABOUT SUNA
bapX is a generalist AI agent that can:
...
Users interact with bapX to accomplish real-world tasks like research, content creation, data analysis, coding, and automation.
...
## FRUSTRATION SIGNALS (bapX-specific)
