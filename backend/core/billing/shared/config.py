...
# Storage Billing Configuration (OpenClaw-style)
# Price in Credits per GB (100 credits = $1.00)
STORAGE_PRICE_PER_GB = Decimal('1.00') # $1.00 per GB
MINIMUM_STORAGE_GB = Decimal('1.0')   # At least 1 GB per month
STORAGE_BILLING_INTERVAL_DAYS = 30
