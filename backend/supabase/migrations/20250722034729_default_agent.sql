...
-- Create RPC function to find bapX default agent for an account
...
-- Create function to get all bapX default agents
...
-- Create function to get bapX default agent statistics
...
BEGIN
    ...
    -- Get active count (all bapX agents are considered active)
