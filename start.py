#!/usr/bin/env python3
"""
bapX bapX Service Manager

Starts and stops bapX services based on the setup method configured
...
def print_banner():
    """Print the bapX bapX banner."""
    print(f"\n{Colors.BLUE}{Colors.BOLD}")
    print("  ╔═══════════════════════════════════════╗")
    print("  ║         bapX bapX Manager           ║")
    print("  ╚═══════════════════════════════════════╝")
    print(f"{Colors.ENDC}")
...
def check_frontend_running() -> bool:
    """Check if the bapX frontend is running (not other Next.js apps like Cursor)."""
...
def check_backend_running() -> bool:
    """Check if the bapX backend is running."""
    root_dir = str(Path.cwd())
...
def start_manual_services(compose_cmd: list) -> int:
    ...
    print(f"{Colors.CYAN}Access bapX at: http://localhost:3000{Colors.ENDC}\n")
...
def show_help():
    ...
    print(__doc__)
    print("Commands:")
    print("  start     Start all bapX services")
    print("  stop      Stop all bapX services")
