...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | bapX',
    description: 'Replay this Worker conversation on bapX',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | bapX';
    const description =
      projectData.description ||
      'Replay this Worker conversation on bapX';
