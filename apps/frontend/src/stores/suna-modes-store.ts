...
export const usebapXModesStore = create<bapXModesState>()(
  persist(
    (set, get) => ({
      selectedMode: null,
      selectedCharts: [],
      ...
      setSelectedMode: (mode: string | null) => {
        ...
        const updates: Partial<bapXModesState> = { selectedMode: mode };
...
export function usebapXModePersistence() {
  const store = usebapXModesStore();
