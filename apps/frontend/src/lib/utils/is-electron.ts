...
export function isElectron(): boolean {
  ...
  // Check user agent for Electron (we append "Electron/bapX-Desktop" in main.js)
 ...
 * - Web: returns the web URL (https://bapx.com/auth/callback)
 * - Electron: returns the custom protocol URL (bapx://auth/callback)
 */
