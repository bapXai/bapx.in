...
export const pricingTiers: PricingTier[] = [
  {
    ...
    description: 'Perfect for trying out bapX AI Workers',
    ...
    features: [
      ...
      '1 concurrent run',
      'Basic Mode - Core bapX experience with basic autonomy',
    ],
    disabledFeatures: [
  ...
  },
  {
    ...
    features: [
      ...
      '5 custom AI Workers - Create bapX Workers with custom Knowledge, Tools & Integrations',
      ...
      'bapX Advanced mode - Strongest autonomy & decision-making capabilities',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      '20 custom AI Workers - Create bapX Workers with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      '100 custom AI Workers - Create bapX Workers with custom Knowledge, Tools & Integrations',
