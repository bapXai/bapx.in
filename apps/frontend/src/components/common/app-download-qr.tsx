 ...
 */
export const APP_DOWNLOAD_URL = 'https://www.bapx.com/app';
...
export interface AppDownloadQRProps {
  ...
  className?: string;
  /** Whether to show the bapX logo in the center */
  showLogo?: boolean;
...
export function AppDownloadQR({ 
  ...
  return (
    <div className={cn("relative bg-white rounded-2xl p-4 shadow-lg", className)}>
      <img 
        src={qrUrl}
        alt="Scan to download bapX - redirects to App Store or Google Play based on your device"
        width={size}
        height={size}
        className="block"
      />
