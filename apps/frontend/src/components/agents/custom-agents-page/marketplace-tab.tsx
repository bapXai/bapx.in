...
interface MarketplaceTabProps {
  ...
  marketplaceFilter: 'all' | 'bapx' | 'community' | 'mine';
  setMarketplaceFilter: (value: 'all' | 'bapx' | 'community' | 'mine') => void;
    ...
    <div className="space-y-6 mt-8 flex flex-col min-h-full">
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          <Select value={marketplaceFilter} onValueChange={(value: 'all' | 'bapx' | 'community' | 'mine') => setMarketplaceFilter(value)}>
            ...
            <SelectContent className='rounded-xl'>
              ...
              <SelectItem className='rounded-xl' value="bapx">bapX Verified</SelectItem>
                  ...
                  {allMarketplaceItems.map((item) => (
                    <UnifiedAgentCard
                      ...
                      data={{
                        ...
                        is_bapx_team: item.is_bapx_team,
