...
const bapXAppBanners = lazy(() => 
  import('@/components/announcements/bapx-app-banners').then(mod => ({ default: mod.bapXAppBanners }))
);
  ...
  return (
    ...
    >
      <div className="relative h-full">
        ...
        {/* bapX App announcement banners */}
        <Suspense fallback={null}>
          <bapXAppBanners disableMobileAdvertising={featureFlags.disableMobileAdvertising} />
        </Suspense>
