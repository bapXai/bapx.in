...
export const usebapXComputerStore = create<bapXComputerState>((set, get) => ({
  ...initialState,
...
export const usebapXComputerIsOpen = () =>
  usebapXComputerStore((state) => state.isOpen);
...
export const usebapXComputerSelectedVersion = () =>
  usebapXComputerStore((state) => state.selectedVersion);

export const usebapXComputerSelectedVersionDate = () =>
  usebapXComputerStore((state) => state.selectedVersionDate);

export const usebapXComputerVersionActions = () =>
