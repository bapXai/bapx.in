...
import bapXSymbolBlack from '@/assets/brand/kortix-symbol-scale-effect-black.svg';
import bapXSymbolWhite from '@/assets/brand/kortix-symbol-scale-effect-white.svg';
...
function AuthBackgroundLogo() {
  ...
  const SymbolComponent = colorScheme === 'dark' ? bapXSymbolWhite : bapXSymbolBlack;
  ...
  return (
    ...
    >
        ...
        <View style={{ marginBottom: SPACING.logoToTitle }}>
          <bapXLogo variant="logomark" size={24} color={isDark ? 'dark' : 'light'} />
        </View>
