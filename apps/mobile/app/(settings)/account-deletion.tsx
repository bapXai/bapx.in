...
export default function AccountDeletionScreen() {
  ...
  const handleRequestDeletion = async () => {
    ...
    try {
      ...
      Alert.alert(t('accountDeletion.deletionScheduled'), t('accountDeletion.deletionScheduledSuccess'), [
        {
          text: t('common.ok'),
          onPress: () => router.back(),
        },
...
function ActionButton({
  ...
  return (
    ...
    >
      {isLoading ? (
        <>
          <bapXLoader size="small" forceTheme={colorScheme === 'dark' ? 'dark' : 'light'} />
