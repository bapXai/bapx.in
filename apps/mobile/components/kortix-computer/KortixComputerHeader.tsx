...
interface bapXComputerHeaderProps {
...
/**
 * Shared header component for all bapX Computer views (Files, File Viewer, Browser).
 ...
 */
export function bapXComputerHeader({
  icon: IconComponent,
  onIconClick,
  iconTitle,
  title,
